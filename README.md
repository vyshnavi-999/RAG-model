...
> Built a production-grade RAG system using Mistral LLMs with hybrid retrieval (FAISS + BM25), Streamlit UI, and hallucination-safe prompting for document-grounded question answering.
